              ...
              for (
                ...
                try {
                  ...
                  if (
                    icErr &&
                    icErr.message &&
                    (icErr.message.includes('Cannot access') ||
                      icErr.message.includes('chrome://') ||
                      icErr.message.includes('edge://'))
                  ) {
                ...
                try {
                  ...
                  if (
                    esErr &&
                    esErr.message &&
                    (esErr.message.includes('Cannot access') ||
                      esErr.message.includes('chrome://') ||
                      esErr.message.includes('edge://'))
                  ) {
                    // Privileged page detected - skip remaining attempts
                    break;
                  }
